                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                        ...
                                        <!-- form start -->
                                        <form action="process_room_add.php" method="post" role="form">
                                            <div class="box-body">
                                                <input hidden name="RM_RoomID" type="text" value=""/>
                                                <div class="form-group">
                                                    <label >ชื่อห้อง</label>
                                                    <input name="RM_RoomName" class="form-control"  placeholder="ชื่อห้อง" value="" required>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="ST_StaffID" class="form-control" required>
                                                       ...
                                                       $sqlS = "SELECT ST_StaffID,ST_StaffName FROM `tb_staff`";
                                                        ...
                                                        <option value="<?= $row['ST_StaffID']; ?>"><?= $row['ST_StaffID'] . ' ' . $row['ST_StaffName']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                <div class="form-group">
