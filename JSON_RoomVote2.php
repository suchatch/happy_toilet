...
$sql = "SELECT tb_room.RM_RoomID, (select count(*) from tb_vote_result Where tb_vote_result.RM_RoomID = tb_room.RM_RoomID and `tb_vote_result`.`VD_VoteID` = 2 and `tb_vote_result`.`VR_CreateDate` BETWEEN '$dtStart 00:00:00' AND '$dtEnd 23:59:59') as Vote FROM tb_room";
