...
<!--                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="RM_RoomID" class="form-control select2" style="width: 100%;">
                                                            <?php
                                                            $sqlCR = "Select RM_RoomID,RM_RoomName from `tb_room`";
                                                            $rsCR = $mysqli_asset->query($sqlCR);
                                                            while ($rowCR = $rsCR->fetch_array()) {
                                                                ?>
                                                                <option value="<?= $rowCR['RM_RoomID']; ?>"><?= $rowCR['RM_RoomName']; ?></option>
                                                                <?php
                                                            }
                                                            ?>
                                                        </select>
                        ...
                        if ($dtStartStr != '01 January 1970') {
                            ...
                            $sqlR = "Select RM_RoomID,RM_RoomName from `tb_room` ";
...
//                                                                var strURL = "JSON_RoomVote1.php";
    ...
    <script>
                                                            ...
                                                            // Vote Room 1
                                                            var ctx = document.getElementById("ChartVoteRoom1").getContext('2d');
                                                            var doughnutChart = new Chart(ctx, {
                                                                ...
                                                                data: {
                                                                    datasets: [{
                                                                            data: [
                                                                                document.getElementById("Vote1Room1").innerHTML,
                                                                                document.getElementById("Vote2Room1").innerHTML,
                                                                                document.getElementById("Vote3Room1").innerHTML,
                                                                                document.getElementById("Vote4Room1").innerHTML
                                                                            ],
                                                                            backgroundColor: [
                                                                                'rgba(75, 192, 192, 1)',
                                                                                'rgba(7,31,158,0.76)',
                                                            ...
                                                            // Issue Room 1
                                                            var ctx = document.getElementById("ChartIssueRoom1").getContext('2d');
                                                            var doughnutChart = new Chart(ctx, {
                                                                type: 'doughnut',
                                                                //            type: 'pie',
                                                                data: {
                                                                    datasets: [{
                                                                            data: [
                                                                                document.getElementById("Issue1Room1").innerHTML,
                                                                                document.getElementById("Issue2Room1").innerHTML,
                                                                                document.getElementById("Issue3Room1").innerHTML,
                                                                                document.getElementById("Issue4Room1").innerHTML,
                                                                                document.getElementById("Issue5Room1").innerHTML,
                                                                                document.getElementById("Issue6Room1").innerHTML
                                                                            ],
                                                                            backgroundColor: [
                                                                                'rgba(255,4,245,0.51)',
                                                                                'rgba(255,4,4,0.51)',
                                                            ...
                                                            /////////////////////2/////////////////
                                                            // Vote Room 2
                                                            var ctx = document.getElementById("ChartVoteRoom2").getContext('2d');
                                                            var doughnutChart = new Chart(ctx, {
                                                                type: 'doughnut',
                                                                //            type: 'pie',
                                                                data: {
                                                                    datasets: [{
                                                                            data: [
                                                                                document.getElementById("Vote1Room2").innerHTML,
                                                                                document.getElementById("Vote2Room2").innerHTML,
                                                                                document.getElementById("Vote3Room2").innerHTML,
                                                                                document.getElementById("Vote4Room2").innerHTML
                                                                            ],
                                                                            backgroundColor: [
                                                                                'rgba(75, 192, 192, 1)',
                                                                                'rgba(7,31,158,0.76)',
                                                            ...
                                                            // Issue Room 2
                                                            var ctx = document.getElementById("ChartIssueRoom2").getContext('2d');
                                                            var doughnutChart = new Chart(ctx, {
                                                                type: 'doughnut',
                                                                //            type: 'pie',
                                                                data: {
                                                                    datasets: [{
                                                                            data: [
                                                                                document.getElementById("Issue1Room2").innerHTML,
                                                                                document.getElementById("Issue2Room2").innerHTML,
                                                                                document.getElementById("Issue3Room2").innerHTML,
                                                                                document.getElementById("Issue4Room2").innerHTML,
                                                                                document.getElementById("Issue5Room2").innerHTML,
                                                                                document.getElementById("Issue6Room2").innerHTML
                                                                            ],
                                                                            backgroundColor: [
                                                                                'rgba(255,4,245,0.51)',
                                                                                'rgba(255,4,4,0.51)',
                                                            ...
                                                            /////////////////3////////////////
                                                            // Vote Room 3
                                                            var ctx = document.getElementById("ChartVoteRoom3").getContext('2d');
                                                            var doughnutChart = new Chart(ctx, {
                                                                type: 'doughnut',
                                                                //            type: 'pie',
                                                                data: {
                                                                    datasets: [{
                                                                            data: [
                                                                                document.getElementById("Vote1Room3").innerHTML,
                                                                                document.getElementById("Vote2Room3").innerHTML,
                                                                                document.getElementById("Vote3Room3").innerHTML,
                                                                                document.getElementById("Vote4Room3").innerHTML
                                                                            ],
                                                                            backgroundColor: [
                                                                                'rgba(75, 192, 192, 1)',
                                                                                'rgba(7,31,158,0.76)',
                                                            ...
                                                            // Issue Room 3
                                                            var ctx = document.getElementById("ChartIssueRoom3").getContext('2d');
                                                            var doughnutChart = new Chart(ctx, {
                                                                type: 'doughnut',
                                                                //            type: 'pie',
                                                                data: {
                                                                    datasets: [{
                                                                            data: [
                                                                                document.getElementById("Issue1Room3").innerHTML,
                                                                                document.getElementById("Issue2Room3").innerHTML,
                                                                                document.getElementById("Issue3Room3").innerHTML,
                                                                                document.getElementById("Issue4Room3").innerHTML,
                                                                                document.getElementById("Issue5Room3").innerHTML,
                                                                                document.getElementById("Issue6Room3").innerHTML
                                                                            ],
                                                                            backgroundColor: [
                                                                                'rgba(255,4,245,0.51)',
                                                                                'rgba(255,4,4,0.51)',
                                                            ...
                                                            /////////////////4///////////////////
                                                            // Vote Room 4
                                                            var ctx = document.getElementById("ChartVoteRoom4").getContext('2d');
                                                            var doughnutChart = new Chart(ctx, {
                                                                type: 'doughnut',
                                                                //            type: 'pie',
                                                                data: {
                                                                    datasets: [{
                                                                            data: [
                                                                                document.getElementById("Vote1Room4").innerHTML,
                                                                                document.getElementById("Vote2Room4").innerHTML,
                                                                                document.getElementById("Vote3Room4").innerHTML,
                                                                                document.getElementById("Vote4Room4").innerHTML
                                                                            ],
                                                                            backgroundColor: [
                                                                                'rgba(75, 192, 192, 1)',
                                                                                'rgba(7,31,158,0.76)',
                                                            ...
                                                            // Issue Room 4
                                                            var ctx = document.getElementById("ChartIssueRoom4").getContext('2d');
                                                            var doughnutChart = new Chart(ctx, {
                                                                type: 'doughnut',
                                                                //            type: 'pie',
                                                                data: {
                                                                    datasets: [{
                                                                            data: [
                                                                                document.getElementById("Issue1Room4").innerHTML,
                                                                                document.getElementById("Issue2Room4").innerHTML,
                                                                                document.getElementById("Issue3Room4").innerHTML,
                                                                                document.getElementById("Issue4Room4").innerHTML,
                                                                                document.getElementById("Issue5Room4").innerHTML,
                                                                                document.getElementById("Issue6Room4").innerHTML
                                                                            ],
                                                                            backgroundColor: [
                                                                                'rgba(255,4,245,0.51)',
                                                                                'rgba(255,4,4,0.51)',
