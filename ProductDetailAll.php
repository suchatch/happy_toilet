...
";
                                            ...
                                            while ($stmt->fetch()) {
                                                ?>
                                                <tr>
                                                    <td><center><img src="dist/img/<?=AssetPicture;?>/<?=iif(empty($PR_Barcode),$PL_Description,$PR_Barcode).".png";?>" width="200px"  alt="User Image"><?=iif(empty($PR_Barcode),"No Barcode",$PR_Barcode);?></center></td>
                                                    <!--<td><img src="dist/img/<?=AssetPicture;?>/<?=iif(empty($PR_Barcode),$PL_Description,$PR_Barcode).".png";?>" width="200px"  alt="User Image"></td>-->
                                                    ...
                                                    <td><?=$Status;?></td>
                                                    <td><?=$PR_Qty;?></td>
                                                    <td><?=date("d/m/Y H:m", strtotime($PR_CreateDate));?></td>
