...
$sql = "SELECT tb_room.RM_RoomID, (select count(*) from tb_issue_result Where tb_issue_result.RM_RoomID = tb_room.RM_RoomID and `tb_issue_result`.`IS_IssueID` = 1 and `tb_issue_result`.`SR_CreateDate` BETWEEN '$dtStart 00:00:00' AND '$dtEnd 23:59:59') as Issue FROM tb_room";
